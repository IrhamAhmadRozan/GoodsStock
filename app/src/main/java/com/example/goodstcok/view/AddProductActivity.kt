...
import com.example.goodstcok.utils.extension.noSpaceDate
...
class AddProductActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivPhotoResult = findViewById(R.id.iv_photo_result)
        tfProductName = findViewById(R.id.tf_product_name)
        spinnerCategory = findViewById(R.id.spinner_category)
        tfProductPrice = findViewById(R.id.tf_product_price)
        tfProductQuantity = findViewById(R.id.tf_product_stock)
        tfDescription = findViewById(R.id.tf_product_description)
    ...
    private fun initSpinner(category: List<Category>) {
        ...
        for (i in category.indices) {
            ...
            val spinnerArrayAdapter =
                ArrayAdapter(this, android.R.layout.simple_spinner_item, listNameCategory)
